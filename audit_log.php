...
<div id="container">
    ...
    <div style="margin:0;padding:0;width:100%;">
        <h2 id="username" style="display:inline-block; vertical-align: middle;">Staff Audit Log</h2>
    </div>
...
<script src="assets/javascript/audit_log.js" type="text/javascript" onload="init('<?php echo $user->getKey(); ?>');"></script>
